...
SECRET_KEY = 'vqj%5z_bv_bgvp@51*q)yqny@-hta%n@g#elf2owfavg2ulnkh'
...
if DEBUG:
    ...
    # DEFAULT_AUTHENTICATION_CLASSES += [
    #     'projectX.rest_api.dev.DevAuthentication'
    # ]
...
RAZORPAY_API_KEY='rzp_test_VR2iva4ym2KHCY'
RAZORPAY_SECRET_KEY='bZXFAk5DGaCiYinHBG1eGWEh'
